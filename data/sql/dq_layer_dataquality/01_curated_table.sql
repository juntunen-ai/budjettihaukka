...
SELECT
  *,
  ...
  CASE WHEN alamomentti_snimi IS NULL THEN NULL WHEN REGEXP_CONTAINS(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '), r'[A-ZÅÄÖ]') AND REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') = UPPER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ')) THEN INITCAP(LOWER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '))) ELSE REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') END AS alamomentti_display,
  CASE WHEN CASE WHEN alamomentti_snimi IS NULL THEN NULL WHEN REGEXP_CONTAINS(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '), r'[A-ZÅÄÖ]') AND REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') = UPPER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ')) THEN INITCAP(LOWER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '))) ELSE REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') END IS NULL THEN NULL WHEN LENGTH(CASE WHEN alamomentti_snimi IS NULL THEN NULL WHEN REGEXP_CONTAINS(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '), r'[A-ZÅÄÖ]') AND REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') = UPPER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ')) THEN INITCAP(LOWER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '))) ELSE REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') END) >= 35 THEN SUBSTR(LOWER(CASE WHEN alamomentti_snimi IS NULL THEN NULL WHEN REGEXP_CONTAINS(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '), r'[A-ZÅÄÖ]') AND REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') = UPPER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ')) THEN INITCAP(LOWER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '))) ELSE REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') END), 1, 35) ELSE LOWER(CASE WHEN alamomentti_snimi IS NULL THEN NULL WHEN REGEXP_CONTAINS(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '), r'[A-ZÅÄÖ]') AND REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') = UPPER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ')) THEN INITCAP(LOWER(REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' '))) ELSE REGEXP_REPLACE(TRIM(alamomentti_snimi), r'\s+', ' ') END) END AS alamomentti_family_key
FROM typed
