...
| `hallituskaudet.html` | Kuukausitoteuma hallituskausittain 1998–; kohdennus enemmistösäännöllä, nimellinen ja reaalinen erikseen | `scripts/test_government_fiscal_eras.py` |
